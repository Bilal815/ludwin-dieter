          ...
          <Col>
           <div className="page__banner">
                <Row className='align-items-center'>
                    <Col lg="9">
                       <h1 className='text-uppercase'>Eye frames</h1>
                       <Breadcrumb>
                       <Breadcrumb.Item href="#">Home</Breadcrumb.Item>
                       <Breadcrumb.Item active>Categories</Breadcrumb.Item>
                       <Breadcrumb.Item active>Eye frames</Breadcrumb.Item>
                       </Breadcrumb>
                    </Col>
                    <Col lg="3"></Col>
     ...
     />
            ...
            <Col lg="9" className='shop__right'>
                ...
                <Row className='mb-4 mt-4 pt-3'>
                    <Col><span className='show__result_count text-secondary '>Showing 1-9 Results</span> </Col>
                    <Col>
                       <Row className='justify-content-end align-items-center sorting'>
                           <Col lg="auto"><span className='text-dark'>Sort by</span></Col>
                           <Col lg="auto">
                           ...
                           <Col lg="auto"><img src={path + productListImg } alt="Product image" /></Col>
                           <Col lg="auto"><img src={path + productGridImg } alt="Product image" /></Col>
                       </Row>
                    </Col>
                </Row>
                <h3 className='text-uppercase mb-5'>CategorY “EYE FRAMEs”</h3>
               <ProductList />
